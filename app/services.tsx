    ...
    return ( <div className="max-w-5xl mx-auto py-20">
        ...
        <div className="text-4xl pb-5 md:text-7xl text-center
         bg-clip-text text-transparent bg-gradient-to-b
          ...
          Streamline your Real Estate business with our services
        </div>
        <p className="mt-4 text-lg font-normal
          text-neutral-300 max-w-lg 
          text-center mx-auto">
          From website design to IDX integrations, We offer a wide range of services to help you grow your business. 
        </p>
